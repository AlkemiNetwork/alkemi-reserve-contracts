...
interface IAlkemiNetwork {
   ...
   */
  function providerLiquidityReserves(address _liquidityProvider) external view returns (address[] memory);
   ...
   */
  function tokenLiquidityReserves(address _asset) external view returns (address[] memory);
